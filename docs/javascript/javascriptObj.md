...
![真实案例：文件上传结果](https://gitee.com/husky-bear/picture-bed/raw/master/books/fileUploadResult.png)
...
![亨元模式重构文件上传结果](https://gitee.com/husky-bear/picture-bed/raw/master/books/fileUploadResult.png)
