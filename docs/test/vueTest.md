...
![jest插件](https://gitee.com/husky-bear/picture-bed/raw/master/test/vue-test1.png)
...
![测试覆盖率](https://gitee.com/husky-bear/picture-bed/raw/master/test/vue-test2.png)
...
- `index.html`: 此处是对`scroll/index.vue`组件测试的一个总结报告，如下：
  ![测试覆盖率](https://gitee.com/husky-bear/picture-bed/raw/master/test/vue-test3.png)

- `index.vue.html`：此处是对`scroll/index.vue`组件测试的一个详细描述，其中对于没有覆盖到的代码进行不同颜色的标识，如下：
  ![测试覆盖率](https://gitee.com/husky-bear/picture-bed/raw/master/test/vue-test4.png)
